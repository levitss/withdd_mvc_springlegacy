...
<head>
    ...
    <link rel="stylesheet" href="dangoffice.css"
...
<body>
    ...
    <div id="print-section">
        <form action="" id="idcard-form">
            <div class="idcard">
                <div class="idcard-header">
                    <div>
                        <input type="text" placeholder="견종" required autofocus>
                    </div>
                    <div>
                        댕댕등록증
                    </div>
                ...
                <div class="idcard-body">
                    <div>
                        <input type="file" accept=".jpg, .jpeg, .png" onchange="previewImage(this)" required>
                        <img id="preview"/>
                    </div>
                    <div>
                        ...
                        <textarea name="hi" id="특징" cols="30" rows="10" minlength="10" placeholder="10자 이상 입력"></textarea>
                    </div>
                </div>
        ...
        <button onclick="printSection()">출력</button>
        <button type="button" id="수정">수 정 하 기</button>
