...
<body>
    ...
    <section class="caremain">
        <img src="./image/caremain.jpg" class="care-img" width="70%" height="auto" />
        <p></p>
        <div class="petbtn" width="70%" height="auto">
            <button type="button" id="petbtn" name="petsitter"><a href="petsitter.html">펫시터 구합니다.</a></button>
            <button type="button" id="petbtn" name="pet"><a href="petsitter.html">펫시터 지원합니다.</a></button>
        </div>
        <div id="care-text" classW="typewriter-effect">
            <div class="text" id="typewriter-text"></div>
        </div>
        <p></p>
        <img src="image/process.png" class="care-img" width="70%" height="auto"/>
