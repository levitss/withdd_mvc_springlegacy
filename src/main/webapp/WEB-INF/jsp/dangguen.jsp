...
<head>
    ...
    <link rel="stylesheet" href="dangguen.css">
...
<body>
    ...
    <section>
        <h5 class="alert alert-light" id="dangguen-head" role="alert" >댕근마켓
        ...
        <button type="button" class="btn-dangguen" id="btn-wright"><a href="dangguenWrite.html">글쓰기</a></button>
        ...
        <div class="container px-4 px-lg-5 mt-5">
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                ...
                <div class="col mb-5">
                    <div class="card h-100">
                        <!-- Sale badge-->
                        <div class="badge bg-dark text-white position-absolute" style="top: 0.5rem; right: 0.5rem">가격낮춤</div>
                        <!-- Product image-->
                        <img class="card-img-top" src="https://dummyimage.com/450x300/dee2e6/6c757d.jpg" alt="..." />
                        <!-- Product details-->
                        <div class="card-body p-4">
